...
ARG PLUGIN_URLS="https://github.com/vaulttec/sonar-auth-oidc/releases/download/v1.0.4/sonar-auth-oidc-plugin-1.0.4.jar,https://github.com/hazim1093/sonar-build-breaker/blob/sonar-7.3/sonar-build-breaker-plugin-2.3-SNAPSHOT.jar"
